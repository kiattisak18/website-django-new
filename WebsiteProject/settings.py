...
# ตรวจสอบว่ารันอยู่บน Render หรือไม่
IS_PRODUCTION = os.getenv('RENDER', 'False') == 'True'
# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/6.0/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-m_571h(h)nr687p&7)e42(&pin)pn3r_y7gbws1$g9es1ka!vl'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = not IS_PRODUCTION

# อนุญาตให้เข้าถึงผ่าน URL ของ Render
ALLOWED_HOSTS = ['*']
if IS_PRODUCTION:
...
# เพิ่มส่วนนี้เพื่อให้ WhiteNoise ทำงานได้เสถียรขึ้น
